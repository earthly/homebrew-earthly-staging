class Earthly < Formula
  ...
  url "https://github.com/earthly/earthly-staging/archive/v0.1661277475.256362909.tar.gz"
  sha256 "da56047f131c99a938adda3767b536f19946418e9907b725974d6e62296465c8"
  license "BUSL-1.1"
  ...
  def install
    ldflags = "-X main.DefaultBuildkitdImage=docker.io/earthly/buildkitd:v#{version} -X main.Version=v#{version} -X main.GitSha=f47c99d2bf7b30b68f3ad2b8f8d2cea5dedccdce "
